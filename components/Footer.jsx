...
const Footer = () => {
  return (
    <footer
      id="contact"
      className=" flex items-center justify-center h-60 w-full mt-12 p-4 bg-titleBG"
    >
      <div className=" w-full h-auto flex flex-col items-center justify-center gap-4">
        <h1 className="text-4xl text-center text-mainLight">
          Contact Me{" "}
          <FaRegHandPointDown className="text-4xl ml-2 text-blue-500 inline" />
        </h1>
        <div className="my-3">
          <Link
            href="mailto:
                serkansafran@outlook.be"
            className="text-2xl text-mainLight  hover:text-gray-500 ease-in duration-200"
          >
            <CiMail className="inline-block text-3xl text-mainLight mr-3  hover:text-gray-500 ease-in duration-200" />
